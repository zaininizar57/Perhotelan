<div class="bg-gray-100 min-h-screen border flex items-center">
    <div class="container mx-auto flex flex-col items-center py-12 sm:py-24">
        <div class="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
            <h1
                ...
                Lorem, ipsum.
                <span class="text-indigo-700">Dolor</span>
                Sit amet consecteture
            </h1>
            <p class="mt-5 sm:mt-10 lg:w-10/12 text-gray-400 font-normal text-center text-sm sm:text-lg">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum fugit labore doloribus dolorum, sint
                nostrum quisquam consectetur mollitia molestiae ad deserunt, natus eligendi ab, voluptate dolore nisi
                modi fuga ipsa!
            </p>
        </div>
